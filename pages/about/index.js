      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 mb-10">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            A few years ago, I started freelancing as a developer. Since then, I've done remote work for agencies, consulted for startups, and collaborated on digital productsfor business and consumer use.
          </motion.p>
          {/* counters */}
          <motion.div 
